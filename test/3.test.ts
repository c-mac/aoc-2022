...
describe.skip('three', () => {
    ...
    test('real', () => {
        ...
        const three = new Three(data)
        expect(three.one()).toBe(7908)
        expect(three.two()).toBe(2838)
    })
